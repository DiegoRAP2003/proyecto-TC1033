...
public:
    ...
    string get_destino();
    void imprime_vuelo(string f_s,string f_r, string d);
    void imprime_vuelo(vuelo v1);
...
//metodo para imprimer un vuelo
void vuelo::imprime_vuelo(vuelo v1){
    cout<<"Su vuelo"<<endl;
    cout<<"De: "<<v1.fecha_salida<<" hasta: "<< v1.fecha_regreso<<endl;
    cout<<"con destino a la ciudad: "<< v1.destino<<endl;
}
